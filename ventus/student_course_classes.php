...
$sql = "CREATE TABLE `org_".STUDENT_COURSE_CLASSES_TABLE."_temp` (
	...
	KEY `fk_".STUDENT_COURSE_CLASSES_TABLE."_".COURSE_CLASSES_TABLE."_idx_".date("Y-m-d H:i")."` (`class_id`),
	CONSTRAINT `fk_org_".STUDENT_COURSE_CLASSES_TABLE."_org_".COURSE_CLASSES_TABLE.date("Y-m-d H:i")."` FOREIGN KEY (`class_id`) REFERENCES `org_".COURSE_CLASSES_TABLE."_temp` (`class_id`) ON DELETE CASCADE ON UPDATE CASCADE
